...
# Script para consolidar toda a documentação em um README único
...
echo -e "${BLUE}📚 CONSOLIDANDO DOCUMENTAÇÃO${NC}"
echo -e "${BLUE}═══════════════════════════════${NC}"
echo ""

# Criar README principal consolidado
cat > README.md << 'EOF'
...
echo -e "${GREEN}✓ README.md principal criado${NC}"

# Criar arquivo de links para documentação adicional
echo -e "${YELLOW}Criando índice de documentação...${NC}"

cat > docs/INDEX.md << 'EOF'
# 📚 Documentação Técnica - Chatbot Epson
...
echo -e "${GREEN}✓ Índice de documentação criado${NC}"

# Remover READMEs duplicados
rm -f README_STREAMLIT.md 2>/dev/null
rm -f docs/README.md 2>/dev/null
rm -f executables/README.md 2>/dev/null
...
echo -e "${GREEN}════════════════════════════════════════${NC}"
echo ""
echo -e "📄 Estrutura da documentação:"
echo "   • README.md          - Documentação principal"
echo "   • docs/INDEX.md      - Índice da documentação técnica"
echo "   • docs/*.md          - Documentação técnica detalhada"
echo "   • DEPLOY_GUIDE.md    - Guia completo de deploy"
echo ""
echo -e "${YELLOW}✨ README.md agora contém toda informação essencial!${NC}"
